...
import type {} from '@nuaagent/client-ui-settings-plugins/client'
...
```jsonc
{
  ...
  "dsh": { "client": { "platform": "web", "inject": ["@nuaagent/client-ui-settings-plugins"] } }
}
```
...
export default clientBundle('@nuaagent/client-my-plugin', ['lib/types/index.js', 'lib/types/invariant.js'])
```
