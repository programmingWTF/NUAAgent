...
export interface Config {
  ...
  tools?: ToolsConfig
  /** NUAAgent home directory exposed to bash and used for local skill discovery. */
  dshHome?: string
...
export interface Config {
  ...
  tools?: ToolsConfig
  /** NUAAgent home directory shared by shell context and local skill discovery. */
  dshHome?: string
...
export interface Config {
  /** NUAAgent home directory exposed as `DSH_HOME`; defaults to `$DSH_HOME` or `~/.dsh`. */
  dshHome?: string
}
```
...
export interface Config {
  ...
  /** NUAAgent config root. Defaults to `$DSH_HOME` or `~/.dsh`. */
  dshHome?: string
...
export interface Config {
  /** Include the fixed NUAAgent identity before the deployment persona (default true). */
...
- `@nuaagent/client-schema-form`（[`packages/client/schema-form/src/index.ts`](../packages/client/schema-form/src/index.ts)）
...
- `@nuaagent/client-web-react`（[`packages/client/web-react/src/index.ts`](../packages/client/web-react/src/index.ts)）
