...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: /^@nuaagent\/client-web$/, replacement: src('../../packages/client/web/src/boot.tsx') },
      { find: /^@nuaagent\/client-web-react$/, replacement: src('../../packages/client/web-react/src/index.ts') },
      { find: /^@nuaagent\/client-ui-slots$/, replacement: src('../../packages/client/ui-slots/src/index.ts') },
      { find: /^@nuaagent\/client-ui-primitives$/, replacement: src('../../packages/client/ui-primitives/src/index.ts') },
      { find: /^@nuaagent\/client-ui-attachment$/, replacement: src('../../packages/client/ui-attachment/src/index.ts') },
      { find: /^@nuaagent\/client-schema-form$/, replacement: src('../../packages/client/schema-form/src/index.ts') },
      { find: /^@nuaagent\/client-modules\/client$/, replacement: src('../../packages/client/modules/src/client/index.ts') },
    ],
  },
  define: {
