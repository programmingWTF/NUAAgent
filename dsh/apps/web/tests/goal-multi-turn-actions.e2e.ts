...
import { parseSessionLog } from '@nuaagent/llm-replay'
import type { SessionEvent, SessionId } from '@nuaagent/session'
import type {} from '@nuaagent/goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@nuaagent/client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@nuaagent/session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@nuaagent/token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@nuaagent/skill-filesystem"}\n',
