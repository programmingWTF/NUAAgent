...
import { bootInjections, orderByModuleGraph } from '@nuaagent/client-modules'
import type { ClientModuleLoaderTarget, WebBootEntry } from '@nuaagent/client-modules/client'
...
const appBoot = await import(pathToFileURL(webBundleResolver.resolve('@nuaagent/app-boot')).href) as unknown as BootComposition
...
export function mountAssembledApp(search = '?fixture'): void {
  ...
  for (const id of ['@nuaagent/client-modules', '@nuaagent/client-runtime']) {
