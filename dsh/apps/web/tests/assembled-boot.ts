...
import type { WebBootEntry } from '@nuaagent/client-modules/client'
...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  { id: '@nuaagent/typert-registry', bundlePath: 'packages/typert/registry/lib/client.js', url: '/plugins/typert-registry.js', rev: 'fx', inject: [], immediately: true },
  { id: '@nuaagent/client-connection', bundlePath: 'packages/client/connection/lib/client.js', url: '/plugins/connection.js', rev: 'fx', inject: [], immediately: true },
  { id: '@nuaagent/api-gateway', bundlePath: 'packages/api/gateway/lib/client.js', url: '/plugins/api-gateway.js', rev: 'fx', inject: ['@nuaagent/typert-registry', '@nuaagent/client-connection'], immediately: true },
  { id: '@nuaagent/api-remotes', bundlePath: 'packages/api/remotes/lib/client.js', url: '/plugins/api-remotes.js', rev: 'fx', inject: ['@nuaagent/api-gateway'], immediately: true },
  ...
  { id: '@nuaagent/client-ui-settings', bundlePath: 'packages/client/ui-settings/lib/client.js', url: '/plugins/ui-settings.js', rev: 'fx', inject: ['@nuaagent/client-connection', '@nuaagent/client-runtime', '@nuaagent/api-remotes'], immediately: true },
  { id: '@nuaagent/client-runtime', bundlePath: 'packages/client/runtime/lib/client.js', url: '/plugins/runtime.js', rev: 'fx', inject: ['@nuaagent/client-connection', '@nuaagent/typert-registry', '@nuaagent/api-gateway'], immediately: true },
  { id: '@nuaagent/client-ui-theme', bundlePath: 'packages/client/ui-theme/lib/client.js', url: '/plugins/ui-theme.js', rev: 'fx', inject: ['@nuaagent/client-connection', '@nuaagent/client-runtime', '@nuaagent/client-locale', '@nuaagent/client-ui-settings', '@nuaagent/api-remotes'], immediately: true },
  { id: '@nuaagent/client-locale', bundlePath: 'packages/client/locale/lib/client.js', url: '/plugins/locale.js', rev: 'fx', inject: ['@nuaagent/client-connection', '@nuaagent/client-runtime', '@nuaagent/client-ui-settings', '@nuaagent/api-remotes'], immediately: true },
  { id: '@nuaagent/client-ui-layout', bundlePath: 'packages/client/ui-layout/lib/client.js', url: '/plugins/ui-layout.js', rev: 'fx', inject: ['@nuaagent/client-runtime'] },
  { id: '@nuaagent/client-ui-sidebar', bundlePath: 'packages/client/ui-sidebar/lib/client.js', url: '/plugins/ui-sidebar.js', rev: 'fx', inject: ['@nuaagent/client-ui-layout'] },
  { id: '@nuaagent/client-ui-conversation', bundlePath: 'packages/client/ui-conversation/lib/client.js', url: '/plugins/ui-conversation.js', rev: 'fx', inject: ['@nuaagent/client-ui-layout'] },
  { id: '@nuaagent/client-ui-tool', bundlePath: 'packages/client/ui-tool/lib/client.js', url: '/plugins/ui-tool.js', rev: 'fx', inject: ['@nuaagent/client-runtime', '@nuaagent/client-locale', '@nuaagent/client-ui-conversation'] },
  { id: '@nuaagent/client-ui-workflow-run', bundlePath: 'packages/client/ui-workflow-run/lib/client.js', url: '/plugins/ui-workflow-run.js', rev: 'fx', inject: ['@nuaagent/client-locale', '@nuaagent/client-runtime', '@nuaagent/client-ui-conversation'] },
  {
    id: '@nuaagent/client-ui-workspace',
    bundlePath: 'packages/client/ui-workspace/lib/client.js',
    url: '/plugins/ui-workspace.js',
    rev: 'fx',
    inject: [
      '@nuaagent/client-runtime',
      '@nuaagent/client-ui-conversation',
      '@nuaagent/client-ui-sidebar',
    ],
  },
  { id: '@nuaagent/session-log-export', bundlePath: 'packages/session-query/session-log-export/lib/client.js', url: '/plugins/session-log-download.js', rev: 'fx', inject: ['@nuaagent/client-ui-commands', '@nuaagent/client-ui-conversation'] },
  { id: '@nuaagent/client-ui-trajectory', bundlePath: 'packages/client/ui-trajectory/lib/client.js', url: '/plugins/ui-trajectory.js', rev: 'fx', inject: ['@nuaagent/client-ui-conversation'] },
]
