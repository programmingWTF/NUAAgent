...
import { boot, healProfilesModuleFallback, loadOverlayPatches } from '@nuaagent/app-boot'
import { provideCmdline } from '@nuaagent/cmdline'
import { SessionId } from '@nuaagent/session'
import type { Agent } from '@nuaagent/agent'
import type { PatchOptions } from '@nuaagent/cordis-plugin-include'
import { afterAll, beforeAll, describe, expect, it } from 'vitest'
import { settingsNamespace } from '@nuaagent/settings'
import { resolveSessionPreset, SETTINGS_NAMESPACE } from '@nuaagent/agent-presets'
import { applyChildComposition, childSessionMeta } from '@nuaagent/subagent'
import { CallId } from '@nuaagent/llm'
import type {} from '@nuaagent/compaction-basic'
import type {} from '@nuaagent/skill'
import type {} from '@nuaagent/tools'
// Type-only: resolves `ctx.get('sessionProjections')` and `ctx.get('tokenMeter')`.
import type {} from '@nuaagent/session-projection'
import type {} from '@nuaagent/token-meter'
...
describe('product subagent rows in user presets', () => {
  ...
  beforeAll(async () => {
    ...
    productCtx = await bootWeb(settingsFile, [
      { insert: [
        { id: 'subagent-codex', name: '@nuaagent/subagent-codex' },
        { id: 'subagent-claude-code', name: '@nuaagent/subagent-claude-code' },
      ] },
      {
        id: 'agent-presets',
        config: {
