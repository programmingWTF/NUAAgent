...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@nuaagent/workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
      name: '@nuaagent/tool-workflow'
```
