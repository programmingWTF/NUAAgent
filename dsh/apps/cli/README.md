...
Bundles named in `dsh.profile.bundles` resolve from the dsh installation first (`@nuaagent/base`, `@nuaagent/web-app`, `@nuaagent/headless`), then from the profile's own `node_modules`, where pnpm installs out-of-tree plugins.
