...
These three **default-off reference configurations** connect one memory system to DSH through [`@nuaagent/mcp-client`](../../packages/mcp/mcp-client/README.md). Pick one, or copy the same generic MCP row for another server.
