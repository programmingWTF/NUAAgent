...
Thank you for your interest in contributing to NUAAgent!
...
NUAAgent is still at an early stage and under active development. We are sorry that we cannot accept external pull requests at the moment. However, contributing code to this repository is far from the only way to help. There are many other ways to get involved:
...
- Contribute to the ecosystem:
  ...
  - Write blog posts and how-to guides about NUAAgent.
  - Answer questions and help other members of the community.

NUAAgent is designed to be deeply customizable. We do not believe that packages in the official repository are inherently more important than packages created by the community. You may consider this repository an idea, an official showcase, and a source of inspiration, but not a mandate from us.
