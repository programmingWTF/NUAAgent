...
function checkManifest(
  ...
  if (owner.packageName === '@nuaagent/invariants') return
  if (manifest.peerDependencies?.['@nuaagent/invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@nuaagent/invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@nuaagent/invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@nuaagent/invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@nuaagent/invariants'
