...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@nuaagent/typert-generator'
import type { CordisCatalogPolicy } from '@nuaagent/typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@nuaagent/cordis'`
 ...
 * scan reads EVERY `declare module '@nuaagent/cordis'` Events merge under
