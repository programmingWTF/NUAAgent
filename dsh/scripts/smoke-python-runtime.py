...
- id: sdk-jsonrpc-server
  name: '@nuaagent/sdk-jsonrpc-server'
- id: agent-core
  name: '@nuaagent/agent-spine-demo'
  config:
...
- id: sessions
  ...
  config:
    ...
    compression: 'none'
- id: code-runtime
  name: '@nuaagent/code-runtime-worker-thread'
- id: subagents
  name: '@nuaagent/subagent'
- id: subagent-spawn-in-process
  name: '@nuaagent/subagent-spawn-in-process'
  config:
    providerName: spawn
- id: subagent-tool
...
- id: cordis-host-runner
  name: '@nuaagent/cordis-host-runner'
- id: cordis-tool
  name: '@nuaagent/tool-cordis'
"""
FS_SEARCH_CORDIS = """\
- id: sdk-jsonrpc-server
  name: '@nuaagent/sdk-jsonrpc-server'
