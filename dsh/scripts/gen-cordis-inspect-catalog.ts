...
import type { CordisCatalogModel, ServiceMethodEntry } from '@nuaagent/typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@nuaagent/tool-cordis/api-catalog', '@nuaagent/cordis-client-runner/client/api-catalog')
