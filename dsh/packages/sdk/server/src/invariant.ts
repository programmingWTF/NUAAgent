/**
 * Package-owned invariant companion for `@nuaagent/sdk-jsonrpc-server`.
 * @module @nuaagent/sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/sdk-jsonrpc-server'
