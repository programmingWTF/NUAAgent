/**
 * Package-owned invariant companion for `@nuaagent/workspace`.
 * @module @nuaagent/workspace/invariant
 */
...
import { WorkspaceId } from '@nuaagent/workspace'

const PACKAGE_NAME = '@nuaagent/workspace'
