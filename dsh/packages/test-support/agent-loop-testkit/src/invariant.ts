/**
 * Package-owned invariant companion for `@nuaagent/agent-loop-testkit`.
 * @module @nuaagent/agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/agent-loop-testkit'
