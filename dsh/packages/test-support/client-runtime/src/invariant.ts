/**
 * Package-owned invariant companion for `@nuaagent/client-test-runtime`.
 * @module @nuaagent/client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-test-runtime'
