...
|---|---|---|
| [`agent-spine-demo/`](agent-spine-demo/README.md) | `@nuaagent/agent-spine-demo` | Reusable agent-spine bundle |
| [`acp-demo/`](acp-demo/README.md) | `@nuaagent/acp-demo` | ACP automation application bundle |
| [`jsonrpc-demo/`](jsonrpc-demo/README.md) | `@nuaagent/sdk-jsonrpc-demo` | External-config JSON-RPC runtime |
