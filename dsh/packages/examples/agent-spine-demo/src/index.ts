 ...
 * @module @nuaagent/agent-spine-demo
 */

import type { Context } from '@nuaagent/cordis'
import Timer from '@nuaagent/cordis-plugin-timer'
import z from '@nuaagent/schemastery'
import LlmRuntime from '@nuaagent/llm'
import SessionStore from '@nuaagent/session'
import SessionTitleService, { type Config as SessionTitleConfig } from '@nuaagent/session-title'
import SystemPrompt, { type Config as SystemPromptConfig } from '@nuaagent/system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@nuaagent/tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@nuaagent/skill'
import * as SkillFileSystem from '@nuaagent/skill-filesystem'
import AgentRegistry from '@nuaagent/agent'
import GoalService, { type Config as GoalDomainConfig } from '@nuaagent/goal'
import * as goalSession from '@nuaagent/goal-round-driver'
import * as toolGoal from '@nuaagent/tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@nuaagent/jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@nuaagent/invariants'
import * as sessionInvariant from '@nuaagent/session/invariant'
import * as agentInvariant from '@nuaagent/agent/invariant'
import * as scopeInvariant from '@nuaagent/scope/invariant'
import * as agentLoopInvariant from '@nuaagent/agent-loop/invariant'
import * as toolBash from '@nuaagent/tool-bash'
import * as bashEnv from '@nuaagent/shell-env'
import * as workspaceContext from '@nuaagent/agent-instructions'
import * as toolSkill from '@nuaagent/tool-skill'
import * as toolJobs from '@nuaagent/tool-jobs'
import AgentLoop, { type Config as AgentLoopConfig } from '@nuaagent/agent-loop'
import * as llmRetry from '@nuaagent/llm-retry'
import { resolveDshHome } from '@nuaagent/home-paths'
