 ...
 * ({@link @nuaagent/agent-spine-demo}), JSONL session persistence, and
 * the {@link @nuaagent/acp} bridge. The app owns those plugins through one
 ...
 * @module @nuaagent/acp-demo
 */

import type { Context } from '@nuaagent/cordis'
import { join } from 'node:path'
import z from '@nuaagent/schemastery'
import * as acp from '@nuaagent/acp'
import * as agentCore from '@nuaagent/agent-spine-demo'
...
} from '@nuaagent/session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@nuaagent/session-checkpoint-policy'
