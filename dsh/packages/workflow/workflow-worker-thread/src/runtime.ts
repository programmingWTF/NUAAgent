 ...
 * @module @nuaagent/workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@nuaagent/llm'
import { SessionId } from '@nuaagent/session'
import { assertObjectJsonSchema, JsonSchemaError } from '@nuaagent/tools'
import type { ObjectJsonSchema } from '@nuaagent/tools'
import { isFatalWorkflowError, WorkflowError } from '@nuaagent/workflow'
import type {
