 ...
 * (`@nuaagent/workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @nuaagent/tool-workflow
 */

import type { Context } from '@nuaagent/cordis'
import z from '@nuaagent/schemastery'
import { defineTool } from '@nuaagent/tools'
import type { ToolCallView, ToolResultView } from '@nuaagent/tools'
import type { ContentBlock } from '@nuaagent/llm'
import type { JsonValue, Session, SessionEventMap } from '@nuaagent/session'
import type {
