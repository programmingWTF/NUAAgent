/**
 * Package-owned invariant companion for `@nuaagent/hooks-claude-code`.
 * @module @nuaagent/hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/hooks-claude-code'
