 ...
 * @module @nuaagent/hooks-claude-code
 */
...
import type { UserMessage } from '@nuaagent/session'
import type {} from '@nuaagent/session-persistence'
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@nuaagent/tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
