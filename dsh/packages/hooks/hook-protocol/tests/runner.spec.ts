...
import type { ShellExecRequest, ShellExecSpec, ShellExecutor, ShellRunResult } from '@nuaagent/shell'
import { DEFAULT_HOOK_TIMEOUT_MS, runHook } from '@nuaagent/hook-protocol'
import type { RunHookOptions } from '@nuaagent/hook-protocol'
