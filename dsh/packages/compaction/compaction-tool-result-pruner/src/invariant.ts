/**
 * Package-owned invariant companion for `@nuaagent/compaction-tool-result-pruner`.
 * @module @nuaagent/compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/compaction-tool-result-pruner'
