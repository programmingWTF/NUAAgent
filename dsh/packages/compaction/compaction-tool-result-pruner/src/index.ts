 ...
 *
 * @module @nuaagent/compaction-tool-result-pruner
 */

import { Context, Service } from '@nuaagent/cordis'
import z from '@nuaagent/schemastery'
import { freezeMessage } from '@nuaagent/llm'
import type { ContentBlock } from '@nuaagent/llm'
import type { Session, SessionEvent, ToolResultMessage } from '@nuaagent/session'
// Type-only: the `compaction/*` SessionEventMap merges (the shadow-price event).
import type {} from '@nuaagent/compaction'
