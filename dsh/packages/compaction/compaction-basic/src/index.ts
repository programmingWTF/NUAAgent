 ...
 *
 * @module @nuaagent/compaction-basic
 */

import { Context } from '@nuaagent/cordis'
import z from '@nuaagent/schemastery'
import { CompactionEngine, ManualCompactionError } from '@nuaagent/compaction'
import type { CompactionResult, CompactionTrigger } from '@nuaagent/compaction'
import type { TokenMeter } from '@nuaagent/token-meter'
import type { Session } from '@nuaagent/session'
import { CONTEXT_WINDOW_EXCEEDED_CODE, assertNever } from '@nuaagent/llm'
import type { LlmCallConfig } from '@nuaagent/llm'
import type { Agent, PreStepDecision } from '@nuaagent/agent'
import type { CommandId } from '@nuaagent/commands/brand'
// Type-only: makes the optional sibling service available to `ctx.get()`.
import type {} from '@nuaagent/compaction-tool-result-pruner'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
