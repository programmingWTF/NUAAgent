...
import CommandRuntime, { type CommandResult } from '@nuaagent/commands'
import {
  CompactionId,
  CompactionEngine,
...
import * as commandCompact from '@nuaagent/command-compact'
...
describe('@nuaagent/command-compact registration', () => {
