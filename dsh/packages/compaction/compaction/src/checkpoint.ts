 ...
 *
 * The seam itself lives in `@nuaagent/compaction`, which re-exports these
 ...
 *
 * @module @nuaagent/compaction/checkpoint
 */

import type { MessageSource } from '@nuaagent/llm/message'
