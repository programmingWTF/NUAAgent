/** Package-owned compaction log-stream invariants. @module @nuaagent/compaction/invariant */

import type { Context } from '@nuaagent/cordis'
import { isReplacementSurfaceEvent } from '@nuaagent/session'
...
const PACKAGE_NAME = '@nuaagent/compaction'
