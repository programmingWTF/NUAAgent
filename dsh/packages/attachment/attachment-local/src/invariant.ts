/** Package-owned invariant companion for `@nuaagent/attachment-local`. @module @nuaagent/attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@nuaagent/cordis'
import type { InvariantInstaller } from '@nuaagent/invariants'

const PACKAGE_NAME = '@nuaagent/attachment-local'
