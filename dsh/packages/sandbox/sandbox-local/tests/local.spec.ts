...
import { LAUNCHER_FAILURE_EXIT } from '@nuaagent/node-addon-landlock-run'
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@nuaagent/sandbox'
import type { SandboxPolicy } from '@nuaagent/sandbox'
import {
  LocalSandboxProvider,
} from '@nuaagent/sandbox-local'
import type { Config } from '@nuaagent/sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @nuaagent/sandbox-windows-acl/tests/provider-chain.spec.ts
