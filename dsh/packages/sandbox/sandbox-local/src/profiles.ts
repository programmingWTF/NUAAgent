 ...
 *
 * @module @nuaagent/sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@nuaagent/node-addon-landlock-run'
 ...
 * (`@nuaagent/fs-sandbox`) can never drift apart.
