/**
 * Package-owned invariant companion for `@nuaagent/sandbox-windows-acl`.
 * @module @nuaagent/sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/sandbox-windows-acl'
