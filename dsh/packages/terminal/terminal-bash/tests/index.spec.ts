...
import AgentRegistry, { Inbox, type Agent } from '@nuaagent/agent'
import SandboxProvider from '@nuaagent/sandbox'
import type { ConfinedArgv, SandboxPolicy } from '@nuaagent/sandbox'
import SandboxPolicyService, { setSandboxMode } from '@nuaagent/sandbox-policy'
import TerminalSessionService, { TerminalBackendCleanupError, TerminalSessionId } from '@nuaagent/terminal'
import type { TerminalSendRequest, TerminalWaitReason } from '@nuaagent/terminal'
import { BashTerminalBackend, PWSH_PROMPT_SETUP } from '@nuaagent/terminal-bash'
import { ENCODING_PREAMBLE } from '@nuaagent/pwsh-local'
import * as ptyLocal from '@nuaagent/terminal-bash'
import type { ResolvedConfig } from '@nuaagent/terminal-bash/src/config.ts'
import type { LocalPtySession } from '@nuaagent/terminal-bash/src/session.ts'
import { SubprocessRuntime } from '@nuaagent/subprocess'
import type {
  SubprocessHandle,
  SubprocessSpawnSpec,
  SubprocessTerminalHandle,
  SubprocessTerminalSpawnSpec,
} from '@nuaagent/subprocess'
