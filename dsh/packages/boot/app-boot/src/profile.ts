 ...
 * @module @nuaagent/app-boot/profile
 */
...
import { applyEntryPatches, type PatchOptions } from '@nuaagent/cordis-plugin-include'
...
export const PROFILE_TEMPLATES: Record<string, readonly string[]> = {
  web: ['@nuaagent/base', '@nuaagent/web-app'],
  headless: ['@nuaagent/base', '@nuaagent/headless'],
}

/** Installation-owned bundle tuples normalized to the shipped template. */
const INSTALLATION_OWNED_PROFILE_TUPLES: Record<string, readonly string[]> = {
  headless: ['@nuaagent/base', '@nuaagent/web-app', '@nuaagent/headless'],
}

/** The bundle list a `dsh plugin` init uses for a name with no shipped template. */
export const DEFAULT_PROFILE_BUNDLES: readonly string[] = ['@nuaagent/base']
 ...
 * `@nuaagent/base` (and every other in-box bundle) always comes from
