/**
 * Package-owned invariant companion for `@nuaagent/settings-file`.
 * @module @nuaagent/settings-file/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/settings-file'
 ...
 * tests; the in-process commit relation is owned by `@nuaagent/settings`.
 */
