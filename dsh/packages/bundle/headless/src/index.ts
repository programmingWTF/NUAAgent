/**
 * @nuaagent/headless — one-shot direct Agent driver. The bundle patch
...
import type { ModelSelectionRef } from '@nuaagent/agent'
import type {} from '@nuaagent/agent-default-model'
...
import type {} from '@nuaagent/cmdline'
