 ...
 *
 * @module @nuaagent/session-reference
 */
...
import { Remote, TypertRemoteService } from '@nuaagent/typert-protocol'
import { createUserMessage, freezeMessage } from '@nuaagent/llm'
import type { ContentBlock, UserMessage } from '@nuaagent/llm'
import type { SessionId } from '@nuaagent/session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@nuaagent/session-query'
import {
