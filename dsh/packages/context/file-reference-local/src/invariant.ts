/**
 * Package-owned invariant companion for `@nuaagent/file-reference-local`.
 * @module @nuaagent/file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/file-reference-local'
