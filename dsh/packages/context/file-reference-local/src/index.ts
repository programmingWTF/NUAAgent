 ...
 *
 * @module @nuaagent/file-reference-local
 */
...
export { FILE_REFERENCE_PROMPT } from '@nuaagent/file-reference'
export { activeAtToken, formatFileMention } from '@nuaagent/file-reference/grammar'
