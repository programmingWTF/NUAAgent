/**
 * Package-owned invariant companion for `@nuaagent/agent-instructions`.
 * @module @nuaagent/agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/agent-instructions'
