 ...
 *
 * @module @nuaagent/agent-instructions/files
 */

import { createReadStream } from 'node:fs'
import { stat } from 'node:fs/promises'
import { dirname, isAbsolute, join, relative, resolve } from 'node:path'
import type { FileSystem, FsInfo, FsTarget, FsVersion } from '@nuaagent/fs'
import { assertNever } from '@nuaagent/llm'
import { dshHomeDisplay } from '@nuaagent/home-paths'
