/**
 * `@nuaagent/web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@nuaagent/llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@nuaagent/web`.
 *
 * @module @nuaagent/web-search-exa
 */
