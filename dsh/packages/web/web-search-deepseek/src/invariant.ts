/**
 * Package-owned invariant companion for `@nuaagent/web-search-deepseek`.
 * @module @nuaagent/web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/web-search-deepseek'
