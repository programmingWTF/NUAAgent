 ...
 * `@nuaagent/tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @nuaagent/web-fetch-http/provider
 */

import { WebError } from '@nuaagent/web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@nuaagent/web'
