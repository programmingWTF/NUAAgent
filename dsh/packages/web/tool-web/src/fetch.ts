...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@nuaagent/tools'
import type { WebFetchBody, WebFetchResult } from '@nuaagent/web'
 ...
 * `@nuaagent/tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@nuaagent/tool-call-timeout-policy` to enforce.
