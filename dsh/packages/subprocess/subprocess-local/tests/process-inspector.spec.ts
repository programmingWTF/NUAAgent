...
import type { ProcessInspectorInternals } from '@nuaagent/subprocess-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@nuaagent/subprocess-local/src/windows-inspector.ts'
