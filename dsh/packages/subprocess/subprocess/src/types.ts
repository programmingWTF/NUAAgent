...
/** Namespace prefix reserved for NUAAgent-managed child environment facts. */
export const DSH_ENV_PREFIX = 'DSH_' as const

/** One environment key inside the managed {@link DSH_ENV_PREFIX} namespace. */
export type DshEnvironmentKey = `${typeof DSH_ENV_PREFIX}${string}`

/** Trusted NUAAgent variables for one child-process execution. */
 ...
 * to `TerminalSignal` in `@nuaagent/terminal` without a cross-seam dependency;
