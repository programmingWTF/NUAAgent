/**
 * Package-owned invariant companion for `@nuaagent/code-runtime-worker-thread`.
 * @module @nuaagent/code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/code-runtime-worker-thread'
