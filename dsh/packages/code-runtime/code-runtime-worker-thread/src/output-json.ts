/** JSON string-prefix accounting for the outer-output ledger. @module @nuaagent/code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@nuaagent/code-runtime'
