/**
 * Package-owned invariant companion for `@nuaagent/code-runtime-python`.
 * @module @nuaagent/code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/code-runtime-python'
