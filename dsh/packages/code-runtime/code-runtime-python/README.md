# @nuaagent/code-runtime-python

English | [中文](README.zh.md)

CPython-subprocess implementation of the [`@nuaagent/code-runtime`](../code-runtime/README.md) seam. Companion to [`@nuaagent/code-runtime-worker-thread`](../code-runtime-worker-thread/README.md); trades the Node worker thread for a fresh `python3` subprocess so model code is Python instead of TypeScript.
