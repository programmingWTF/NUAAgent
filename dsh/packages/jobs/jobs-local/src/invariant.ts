/**
 * Package-owned invariant companion for `@nuaagent/jobs-local`.
 * @module @nuaagent/jobs-local/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/jobs-local'
...
/**
 * No runtime invariant: `@nuaagent/jobs/invariant` owns per-snapshot identity, status,
