/**
 * Package-owned invariant companion for `@nuaagent/agent-presets`.
 * @module @nuaagent/agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@nuaagent/agent-presets'

const PACKAGE_NAME = '@nuaagent/agent-presets'
