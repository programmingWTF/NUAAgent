 ...
 * @module @nuaagent/agent-presets
 */

import { stat } from 'node:fs/promises'
import { Context, Service } from '@nuaagent/cordis'
import z from '@nuaagent/schemastery'
import { bindScopeParent, createScope, scopeOf, type Scope, type ScopeKey, type ScopeParentBinding } from '@nuaagent/scope'
// Type-only: resolves the `agent/created` lifecycle event this service watches.
import type {} from '@nuaagent/agent'
import { settingsNamespace, type SettingsScope, type default as SettingsService } from '@nuaagent/settings'
