 ...
 * @module @nuaagent/agent-presets/mount
 */
...
import type { EntryTree } from '@nuaagent/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@nuaagent/scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@nuaagent/*` row would fail to import. The
