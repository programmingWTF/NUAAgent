/** Package-owned goal-round prompt invariants. @module @nuaagent/goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@nuaagent/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@nuaagent/goal'
import type { InvariantFailure, InvariantInstaller } from '@nuaagent/invariants'
import type { Session, SessionEvent } from '@nuaagent/session'
import { renderGoalRoundPrompt } from './prompt.ts'

const PACKAGE_NAME = '@nuaagent/goal-round-driver'
