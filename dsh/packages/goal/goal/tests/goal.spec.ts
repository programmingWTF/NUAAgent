...
import { createUserMessage, HarnessError } from '@nuaagent/llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@nuaagent/session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
...
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@nuaagent/goal'
...
function stubAgent(rawId: string, seed?: readonly import('@nuaagent/session').SessionEvent[]): StubAgent {
