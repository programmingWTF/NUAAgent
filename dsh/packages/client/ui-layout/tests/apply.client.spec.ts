...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@nuaagent/client-ui-theme/client'
import { apply, inject, LayoutController } from '@nuaagent/client-ui-layout/client'
import { apply as nodeApply } from '@nuaagent/client-ui-layout'
import * as invariant from '@nuaagent/client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@nuaagent/client-ui-layout', expect.any(Function))
