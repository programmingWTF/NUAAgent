...
import type { ThemeSnapshot } from '@nuaagent/client-ui-theme/client'
import { DARK_ATTRIBUTE, ThemePresenter } from '@nuaagent/client-ui-layout/src/client/theme-presenter.ts'
