/**
 * Package-owned invariant companion for `@nuaagent/client-ui-permission-presets`.
 * @module @nuaagent/client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-permission-presets'
