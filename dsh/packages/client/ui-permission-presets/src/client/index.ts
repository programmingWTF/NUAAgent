 ...
 */
import type { ConnectionHandle } from '@nuaagent/api-remotes/client'
...
import type {} from '@nuaagent/client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@nuaagent/api-remotes/client'
import type { ClientContext, SessionFace } from '@nuaagent/client-runtime/client'
import type { CommandUiContract, SelectOption } from '@nuaagent/client-ui-commands/client'
import type { ClientSessionContext } from '@nuaagent/client-ui-input-trigger/client'
