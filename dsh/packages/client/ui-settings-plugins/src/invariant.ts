/**
 * Package-owned invariant companion for `@nuaagent/client-ui-settings-plugins`.
 * @module @nuaagent/client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-settings-plugins'
