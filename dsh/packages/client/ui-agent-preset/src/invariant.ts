/**
 * Package-owned invariant companion for `@nuaagent/client-ui-agent-preset`.
 * @module @nuaagent/client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-agent-preset'
