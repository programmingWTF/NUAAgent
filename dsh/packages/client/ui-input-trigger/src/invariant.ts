/**
 * Package-owned invariant companion for `@nuaagent/client-ui-input-trigger`.
 * @module @nuaagent/client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-input-trigger'
