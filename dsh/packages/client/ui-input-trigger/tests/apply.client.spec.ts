...
import { usePinnedBrowserLanguages } from '@nuaagent/client-test-runtime'
import { createScope, scopeOf, SlotRegistry } from '@nuaagent/client-runtime/client'
import type { SessionId } from '@nuaagent/client-runtime/client'
import { apply, inject, InputTriggerService } from '@nuaagent/client-ui-input-trigger/client'
import type { MenuViewInjected } from '@nuaagent/client-ui-input-trigger/client'
