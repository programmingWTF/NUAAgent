/**
 * Package-owned invariant companion for `@nuaagent/client-ui-settings-models`.
 * @module @nuaagent/client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-settings-models'
