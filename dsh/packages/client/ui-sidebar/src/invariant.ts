/**
 * Package-owned invariant companion for `@nuaagent/client-ui-sidebar`.
 * @module @nuaagent/client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-sidebar'
