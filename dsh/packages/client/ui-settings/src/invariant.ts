/**
 * Package-owned invariant companion for `@nuaagent/client-ui-settings`.
 * @module @nuaagent/client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-settings'
