/**
 * Package-owned invariant companion for `@nuaagent/client-ui-model-selection`.
 * @module @nuaagent/client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-model-selection'
