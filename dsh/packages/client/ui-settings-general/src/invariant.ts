/**
 * Package-owned invariant companion for `@nuaagent/client-ui-settings-general`.
 * @module @nuaagent/client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-settings-general'
