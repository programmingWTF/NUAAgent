...
import type { IApiClient } from '@nuaagent/api-remotes/client'
import { createSnapshotStore, type SnapshotStore } from '@nuaagent/client-runtime/client'
import type { SettingsDescribeFace } from '@nuaagent/client-ui-settings/client'
