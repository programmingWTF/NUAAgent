...
import type { ChatFileMentions, TurnTailOwnerProps } from '@nuaagent/client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@nuaagent/client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@nuaagent/client-ui-deliverables'])
