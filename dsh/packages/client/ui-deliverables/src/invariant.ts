/**
 * Package-owned invariant companion for `@nuaagent/client-ui-deliverables`.
 * @module @nuaagent/client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-deliverables'
