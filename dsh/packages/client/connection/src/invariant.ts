/**
 * Package-owned invariant companion for `@nuaagent/client-connection`.
 * @module @nuaagent/client-connection/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-connection'
