/**
 * Package-owned invariant companion for `@nuaagent/client-ui-primitives`.
 * @module @nuaagent/client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-primitives'
