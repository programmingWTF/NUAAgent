...
import { apply, inject } from '@nuaagent/client-ui-workspace/client'
import type { WorkspaceBrowserInjected, WorkspacePickerInjected } from '@nuaagent/client-ui-workspace/client'
