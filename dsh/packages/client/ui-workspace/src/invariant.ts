/**
 * Package-owned invariant companion for `@nuaagent/client-ui-workspace`.
 * @module @nuaagent/client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-workspace'
