...
import type { HostDescription } from '@nuaagent/client-connection/client'
import type {
  ChatConversationViewNode, ChatSnapshot, ConversationNode, RunningToolCall, SessionId,
} from '@nuaagent/client-runtime/client'
import type { SessionProviderComponent, TranslateNS } from '@nuaagent/client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@nuaagent/client-ui-conversation/src/client/contract/slots.ts'
