...
import type { InjectFace, PropsLocale, PropsRenderSlots, PropsRuntime } from '@nuaagent/client-ui-slots'
import type { ToolCallBlock } from '@nuaagent/client-runtime/client'
