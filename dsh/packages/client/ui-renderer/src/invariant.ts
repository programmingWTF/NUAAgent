/**
 * Package-owned invariant companion for `@nuaagent/client-ui-renderer`.
 * @module @nuaagent/client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-renderer'
