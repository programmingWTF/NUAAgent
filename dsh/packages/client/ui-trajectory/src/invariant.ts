/**
 * Package-owned invariant companion for `@nuaagent/client-ui-trajectory`.
 * @module @nuaagent/client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-trajectory'
