 ...
 * not built (`pnpm --filter @nuaagent/client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@nuaagent/client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@nuaagent/client-runtime/client', await import('@nuaagent/client-runtime/client')],
      ['@nuaagent/client-ui-primitives', await import('@nuaagent/client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@nuaagent/client-locale/client')
