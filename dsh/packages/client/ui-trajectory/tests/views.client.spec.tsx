...
import { SlotRegistry } from '@nuaagent/client-runtime/client'
import type {
  ConversationSnapshot, RequestView,
  SessionId, SessionListState, SnapshotStore, WorkspaceListState,
} from '@nuaagent/client-runtime/client'
import type { ConvViewProps, ViewTab } from '@nuaagent/client-ui-conversation/client'
import {
  ConversationSession, ConversationSessionHeader,
  type ConversationSessionHeaderProps, type ConversationSessionProps,
} from '@nuaagent/client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@nuaagent/client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@nuaagent/client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@nuaagent/client-locale/client'
import { stubSettingsScope } from '@nuaagent/client-test-runtime'
import type { LocaleKeysOf } from '@nuaagent/client-ui-slots'
import { zh, type TrajectoryKey } from '../src/client/locales.ts'
import { apply, inject } from '@nuaagent/client-ui-trajectory/client'
import { apply as nodeApply } from '@nuaagent/client-ui-trajectory'
