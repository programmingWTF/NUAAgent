...
import type { ClientSessionContext, CommandClaim, PickOutcome, SubmitOutcome } from '@nuaagent/client-ui-input-trigger/client'
...
import type { ConversationSnapshot } from '@nuaagent/client-runtime/client'
