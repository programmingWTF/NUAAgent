/**
 * Package-owned invariant companion for `@nuaagent/client-ui-conversation`.
 * @module @nuaagent/client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-conversation'
