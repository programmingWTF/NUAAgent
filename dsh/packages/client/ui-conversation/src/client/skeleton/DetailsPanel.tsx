...
import { shallowEqual } from '@nuaagent/client-runtime/client'
import type { ConversationSnapshot, RunningToolCall, ToolCallBlock, ToolResultNode } from '@nuaagent/client-runtime/client'
