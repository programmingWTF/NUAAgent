...
} from '@nuaagent/client-ui-primitives'
import { AttachmentRail, DropOverlay, ImageLightbox } from '@nuaagent/client-ui-attachment'
import type { AttachmentRailItem } from '@nuaagent/client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@nuaagent/plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@nuaagent/goal/client'
...
import type { Translate } from '@nuaagent/client-ui-slots'
