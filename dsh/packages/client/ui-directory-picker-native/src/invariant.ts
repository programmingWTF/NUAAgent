/**
 * Package-owned invariant companion for `@nuaagent/client-ui-directory-picker-native`.
 * @module @nuaagent/client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-directory-picker-native'
