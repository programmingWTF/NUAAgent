/** Package-owned invariant companion. @module @nuaagent/client-ui-settings-plugin-inventory/invariant */

/* jscpd:ignore-start */
import type { Context } from '@nuaagent/cordis'
import type { InvariantInstaller } from '@nuaagent/invariants'

const PACKAGE_NAME = '@nuaagent/client-ui-settings-plugin-inventory'
