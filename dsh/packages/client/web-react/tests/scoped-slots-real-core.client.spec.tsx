...
import { SlotCore, type PropsRenderSlots, type SlotRendererHost } from '@nuaagent/client-ui-slots'
import { createSlotRenderer, StaleAuthorizationError } from '@nuaagent/client-web-react'
