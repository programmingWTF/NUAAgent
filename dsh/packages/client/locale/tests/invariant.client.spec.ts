...
import { apply as nodeApply } from '@nuaagent/client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@nuaagent/client-locale/client'
import * as LocaleInvariant from '@nuaagent/client-locale/invariant'
