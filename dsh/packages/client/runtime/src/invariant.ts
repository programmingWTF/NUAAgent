/**
 * Package-owned invariant companion for `@nuaagent/client-runtime`.
 * @module @nuaagent/client-runtime/invariant
 */
...
import type { SlotMap } from '@nuaagent/client-ui-slots'
import type { InvariantInstaller } from '@nuaagent/invariants'

const PACKAGE_NAME = '@nuaagent/client-runtime'
