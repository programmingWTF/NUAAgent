/**
 * Package-owned invariant companion for `@nuaagent/client-ui-attachment`.
 * @module @nuaagent/client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-attachment'
