...
import type { GoalSnapshot } from '@nuaagent/goal/client'
import {
...
import type { PropsLocale } from '@nuaagent/client-ui-slots'
...
export type GoalDockProps = import('@nuaagent/client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
