...
import { ConversationNodeAssembler } from '@nuaagent/client-runtime/client'
...
import type { SessionEvent } from '@nuaagent/session/types'
import { commandDefinition } from '@nuaagent/client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@nuaagent/client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
