...
import { ConversationEventRegistry } from '@nuaagent/client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@nuaagent/goal/client'
