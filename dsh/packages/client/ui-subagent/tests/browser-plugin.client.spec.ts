...
import type { ComposerChainProps } from '@nuaagent/client-ui-conversation/client'
import { InputTriggerService } from '@nuaagent/client-ui-input-trigger/client'
import type { ClientSessionContext, InputTriggerSource } from '@nuaagent/client-ui-input-trigger/client'
import { apply as applyLocale, inject as localeInject } from '@nuaagent/client-locale/client'
import {
