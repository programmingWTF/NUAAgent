/**
 * Package-owned invariant companion for `@nuaagent/client-ui-subagent`.
 * @module @nuaagent/client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-subagent'
