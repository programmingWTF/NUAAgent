/**
 * Package-owned invariant companion for `@nuaagent/client-ui-user-questions`.
 * @module @nuaagent/client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-user-questions'
