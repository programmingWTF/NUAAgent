/**
 * Package-owned invariant companion for `@nuaagent/client-ui-commands`.
 * @module @nuaagent/client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-commands'
