/**
 * Package-owned invariant companion for `@nuaagent/client-ui-brand-official`.
 * @module @nuaagent/client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-brand-official'
