 ...
 * @module @nuaagent/client-web/src/boot
 */
...
} from '@nuaagent/client-modules/client'
import type {} from '@nuaagent/client-ui-renderer/client'
...
export class AppWebEntry {
  ...
  async run(): Promise<void> {
    try {
      ...
      // is `ClientTransportHooks`, owned by @nuaagent/client-connection;
