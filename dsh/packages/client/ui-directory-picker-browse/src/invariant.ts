/**
 * Package-owned invariant companion for `@nuaagent/client-ui-directory-picker-browse`.
 * @module @nuaagent/client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-directory-picker-browse'
