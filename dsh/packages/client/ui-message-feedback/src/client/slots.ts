 ...
 * @module @nuaagent/client-ui-message-feedback/client/slots
 */
...
import type { MessageId } from '@nuaagent/client-connection/client'
import type { MessageFeedbackRating } from '@nuaagent/message-feedback/types'
