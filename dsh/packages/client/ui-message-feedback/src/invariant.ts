/**
 * Package-owned invariant companion for `@nuaagent/client-ui-message-feedback`.
 * @module @nuaagent/client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-message-feedback'
