/**
 * Package-owned invariant companion for `@nuaagent/client-ui-reference`.
 * @module @nuaagent/client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/client-ui-reference'
