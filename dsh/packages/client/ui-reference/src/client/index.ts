 ...
 * ordering and labels.
 *
 * @module @nuaagent/client-ui-reference/client
 */
...
} from '@nuaagent/client-ui-input-trigger/client'
import { formatFileMention } from '@nuaagent/file-reference/grammar'
import type { FileReferenceCandidate } from '@nuaagent/file-reference/types'
import type { SessionReferenceMentionCandidate } from '@nuaagent/session-reference/types'
