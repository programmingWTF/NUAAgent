 ...
 * @module @nuaagent/client-modules
 */
...
import type { IndexInjection } from '@nuaagent/host-webserver'
...
const CLIENT_MODULES_ID = '@nuaagent/client-modules'

/** Dynamic package whose ordinary client bundle must be registered before plugin boot starts. */
const CLIENT_RUNTIME_ID = '@nuaagent/client-runtime'
