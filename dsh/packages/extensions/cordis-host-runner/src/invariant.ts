/**
 * Package-owned invariant companion for `@nuaagent/cordis-host-runner`.
 * @module @nuaagent/cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/cordis-host-runner'
