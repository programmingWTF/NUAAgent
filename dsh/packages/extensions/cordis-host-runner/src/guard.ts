 ...
 * @module @nuaagent/cordis-host-runner/guard
 */

import { Context } from '@nuaagent/cordis'
import type { Plugin } from '@nuaagent/cordis'
import { scopeOf } from '@nuaagent/scope'
import { assertSupportedJsonSchema, defineTool } from '@nuaagent/tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@nuaagent/cordis-client-runner`, whose CTX_VERBS names this one its
