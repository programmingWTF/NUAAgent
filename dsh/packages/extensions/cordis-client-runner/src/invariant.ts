/**
 * Package-owned invariant companion for `@nuaagent/cordis-client-runner`.
 * @module @nuaagent/cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/cordis-client-runner'
