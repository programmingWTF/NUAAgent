/**
 * Package-owned invariant companion for `@nuaagent/anonymous-user-id`.
 * @module @nuaagent/anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/anonymous-user-id'
