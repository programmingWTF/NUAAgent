...
import { createUserMessage, CallId, HarnessError, type ContentBlock  } from '@nuaagent/llm'
import SystemPrompt from '@nuaagent/system-prompt'
import type { Agent } from '@nuaagent/agent'
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@nuaagent/user-approval'
import ToolRuntime, {
