...
import { bindScopeParent, createScope } from '@nuaagent/scope'
...
import type { PreToolDecision, ToolDefinition, ToolExecution, ToolExecutionInput, ToolExecutionToken } from '@nuaagent/tools'
