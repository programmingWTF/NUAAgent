 ...
 * @module @nuaagent/agent-loop/invariant
 */

import type { Context } from '@nuaagent/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@nuaagent/llm'
import type { InvariantFailure, InvariantInstaller } from '@nuaagent/invariants'
import { foldRequestHeader } from '@nuaagent/session'

const PACKAGE_NAME = '@nuaagent/agent-loop'
