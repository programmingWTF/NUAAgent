/** Package-owned scoped-dispatch invariants. @module @nuaagent/scope/invariant */

import type { Context } from '@nuaagent/cordis'
import type { InvariantInstaller } from '@nuaagent/invariants'
import { carrierKeyOf, isScopeCarrier } from '@nuaagent/scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@nuaagent/scope'
