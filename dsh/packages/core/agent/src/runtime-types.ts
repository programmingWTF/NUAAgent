 ...
 * turn/step boundaries remain `@nuaagent/session` events.
 *
...
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@nuaagent/llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@nuaagent/session'
export type { AgentCancelCause } from '@nuaagent/session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@nuaagent/system-prompt'
declare module '@nuaagent/system-prompt' {
...
declare module '@nuaagent/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@nuaagent/scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
