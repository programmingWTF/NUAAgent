 ...
 *
 * @module @nuaagent/agent
 */

import { Context, FiberState, getTraceable, Service, symbols } from '@nuaagent/cordis'
import type { Fiber } from '@nuaagent/cordis'
import { AsyncLocalStorage } from 'node:async_hooks'
import { isPromise } from 'node:util/types'
import { scopeTarget } from '@nuaagent/scope'
import type { Scoped } from '@nuaagent/scope'
import type { SessionEvent, SessionId } from '@nuaagent/session'
import type { TypertContext, TypertLookup } from '@nuaagent/typert-protocol'
 ...
 * (`@nuaagent/agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@nuaagent/agent#Agent',
