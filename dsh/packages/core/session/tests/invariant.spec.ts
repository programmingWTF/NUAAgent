...
import { createScope, scopeTarget } from '@nuaagent/scope'
import { createUserMessage, CallId, createMessage, createToolResultMessage, freezeMessage } from '@nuaagent/llm'
import SessionStore, { SessionId, TOOL_NOT_STARTED } from '@nuaagent/session'
import * as SessionInvariant from '@nuaagent/session/invariant'
import InvariantRegistry, { InvariantError } from '@nuaagent/invariants'
