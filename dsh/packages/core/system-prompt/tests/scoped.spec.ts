...
import { createScope, scopeOf } from '@nuaagent/scope'
import type { Scope, ScopeKey } from '@nuaagent/scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@nuaagent/system-prompt'
import type { Config, PromptAssembly } from '@nuaagent/system-prompt'
