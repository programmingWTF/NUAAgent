...
import type { SessionProjectionRegistry } from '@nuaagent/session-projection'
import type { SessionProjectionCache } from '@nuaagent/session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @nuaagent/session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @nuaagent/session)',
