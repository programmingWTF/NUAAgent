 ...
 * (`@nuaagent/subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@nuaagent/tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@nuaagent/tools'
import type { ContentBlock, MessageId } from '@nuaagent/llm'
