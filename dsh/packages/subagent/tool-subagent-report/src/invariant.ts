/**
 * Package-owned invariant companion for `@nuaagent/tool-subagent-report`.
 * @module @nuaagent/tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/tool-subagent-report'
