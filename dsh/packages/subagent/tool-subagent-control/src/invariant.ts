/**
 * Package-owned invariant companion for `@nuaagent/tool-subagent-control`.
 * @module @nuaagent/tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/tool-subagent-control'
