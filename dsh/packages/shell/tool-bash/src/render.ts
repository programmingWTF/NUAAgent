 ...
 *
 * @module @nuaagent/tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@nuaagent/shell'
import type { SandboxMode } from '@nuaagent/sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@nuaagent/sandbox'
 ...
 * rendering story, owned by `@nuaagent/shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@nuaagent/shell'
