/**
 * Package-owned invariant companion for `@nuaagent/tool-bash-persistent`.
 * @module @nuaagent/tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/tool-bash-persistent'
