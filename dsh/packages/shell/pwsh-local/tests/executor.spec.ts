/**
 * Real-process tests for `@nuaagent/pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@nuaagent/pwsh-local'
import LocalSubprocessRuntime from '@nuaagent/subprocess-local'
import SubprocessRuntime from '@nuaagent/subprocess'
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@nuaagent/subprocess'
import { MAX_TIMER_DELAY_MS } from '@nuaagent/timeout'
import type { ShellProcess } from '@nuaagent/shell'
