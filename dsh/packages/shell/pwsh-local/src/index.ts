...
import { SHELL_SETTINGS_NAMESPACE, ShellExecutor } from '@nuaagent/shell'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellProcessRead, ShellRunResult, CollectedOutput } from '@nuaagent/shell'
import type { SubprocessCollect, SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@nuaagent/subprocess'
import { installSettingsSection } from '@nuaagent/settings'
import { clampTimeout, deadline, MAX_TIMER_DELAY_MS, timeoutOf } from '@nuaagent/timeout'
/* jscpd:ignore-end */
...
export class PwshLocalExecutor extends ShellExecutor {
   ...
   * pwsh-confining consumer is `@nuaagent/pwsh-sandbox`.
