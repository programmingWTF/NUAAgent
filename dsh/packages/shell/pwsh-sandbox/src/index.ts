 ...
 * `@nuaagent/bash-sandbox`. It wraps the exact local pwsh argv through
...
import { SandboxUnavailableError } from '@nuaagent/sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,
