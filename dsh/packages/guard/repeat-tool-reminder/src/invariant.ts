/**
 * Package-owned invariant companion for `@nuaagent/repeat-tool-reminder`.
 * @module @nuaagent/repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/repeat-tool-reminder'
