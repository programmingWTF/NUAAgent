/**
 * Unit + real-load-path coverage for @nuaagent/tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@nuaagent/llm'
import SystemPrompt from '@nuaagent/system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@nuaagent/tools'
import * as timeoutPolicy from '@nuaagent/tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@nuaagent/tool-call-timeout-policy'
