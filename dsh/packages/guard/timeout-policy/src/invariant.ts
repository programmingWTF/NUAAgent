/**
 * Package-owned invariant companion for `@nuaagent/tool-call-timeout-policy`.
 * @module @nuaagent/tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/tool-call-timeout-policy'
