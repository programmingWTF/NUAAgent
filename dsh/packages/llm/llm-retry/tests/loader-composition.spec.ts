...
import LlmRuntime, { createUserMessage, LlmAdapter, LlmError, resolveRetryPolicy  } from '@nuaagent/llm'
import type { GenerateOptions, ResolvedRetryPolicy, StreamChunk } from '@nuaagent/llm'
...
async function loadYaml(lines: readonly string[]): Promise<Context> {
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@nuaagent/llm-retry', retry],
    ['@nuaagent/agent-loop', AgentLoop],
  ])
