/** Package-owned durable retry-event invariants. @module @nuaagent/llm-retry/invariant */

import type { Context } from '@nuaagent/cordis'
import type { Session, SessionEvent } from '@nuaagent/session'
import type { LlmFailure } from '@nuaagent/llm'
...
const PACKAGE_NAME = '@nuaagent/llm-retry'
