...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@nuaagent/authorization'
import { isCredentialKeySegment } from '@nuaagent/credentials'
