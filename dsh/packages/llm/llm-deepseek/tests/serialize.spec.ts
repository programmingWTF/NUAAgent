...
import type { ImageAttachmentRef, ImageMediaType, RequestImageAttachment } from '@nuaagent/attachment'
import { createUserMessage, CallId, ReasoningEffortId, createMessage } from '@nuaagent/llm'
import type { ContentBlock, GenerateOptions, Message } from '@nuaagent/llm'
import {
  serializeMessages,
