/**
 * Package-owned invariant companion for `@nuaagent/tool-str-replace-editor`.
 * @module @nuaagent/tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/tool-str-replace-editor'
