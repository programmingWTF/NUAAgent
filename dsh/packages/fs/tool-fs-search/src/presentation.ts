 ...
 * model-facing render consumes ({@link module:@nuaagent/tool-fs-search/search-core}
 ...
 *
 * @module @nuaagent/tool-fs-search/presentation
 */
 ...
 * ({@link module:@nuaagent/tool-fs-search/grep} `formatGrepMatches`), so
