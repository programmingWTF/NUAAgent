 ...
 *
 * @module @nuaagent/tool-fs-search/grep
 */

import type { Context } from '@nuaagent/cordis'
import { defineTool } from '@nuaagent/tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@nuaagent/tools'
import type { RetainedItems } from '@nuaagent/output-retention'
import type { SpillRef } from '@nuaagent/spill'
