...
import { FsTargetKey, FsVersion } from '@nuaagent/fs'
import type { FsObservation, FsTarget, FsWriteIntent } from '@nuaagent/fs'
import * as FsPolicy from '@nuaagent/fs-observation-policy'
import type { FsObservationActor } from '@nuaagent/fs-observation-policy'
