/**
 * Package-owned invariant companion for `@nuaagent/launch-environment`.
 * @module @nuaagent/launch-environment/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/launch-environment'
