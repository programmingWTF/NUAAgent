 ...
 * @module @nuaagent/message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@nuaagent/cordis'
import s from '@nuaagent/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@nuaagent/session/surface'
import type { SessionHeader, SessionId } from '@nuaagent/session/types'
import type { SessionInspection } from '@nuaagent/session-persistence'
import type { KvTable } from '@nuaagent/storage-domain'
