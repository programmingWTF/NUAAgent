...
import SessionStore, { foldSurface, Session, SessionId } from '@nuaagent/session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@nuaagent/session-telemetry'
import * as commandFeedback from '@nuaagent/command-feedback'
...
vi.mock('@nuaagent/anonymous-user-id', () => ({
...
describe('@nuaagent/command-feedback registration', () => {
