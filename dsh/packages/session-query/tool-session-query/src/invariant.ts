/**
 * Package-owned invariant companion for `@nuaagent/tool-session-query`.
 * @module @nuaagent/tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/tool-session-query'
