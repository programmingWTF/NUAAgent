 ...
 *
 * @module @nuaagent/session-query
 */

import { Context, Service } from '@nuaagent/cordis'
import { Session, snapshotSessionEvent, type SessionId } from '@nuaagent/session'
import { foldSessionTitle } from '@nuaagent/session-title'
import type { SessionTitleSnapshot } from '@nuaagent/session-title'
import type {
