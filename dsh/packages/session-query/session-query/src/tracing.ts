...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from '@nuaagent/session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from '@nuaagent/session'
