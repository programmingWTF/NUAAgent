/**
 * Package-owned invariant companion for `@nuaagent/session-query-sqlite`.
 * @module @nuaagent/session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/session-query-sqlite'
