import { createAssistantMessage, createUserMessage } from '@nuaagent/llm'
import { afterEach, describe, expect, it, vi } from 'vitest'
import { Context, type Fiber } from '@nuaagent/cordis'
import { DatabaseSync } from 'node:sqlite'
import { chmod, mkdtemp, rm, stat, writeFile } from 'node:fs/promises'
import { tmpdir } from 'node:os'
import { dirname, join } from 'node:path'
import SessionStore, { SESSION_FORMAT_VERSION, SessionId } from '@nuaagent/session'
import type { SessionEvent, SessionHeader, SessionId as SessionIdType } from '@nuaagent/session'
import SessionPersistence, { SessionPersistenceRevision } from '@nuaagent/session-persistence'
import type { SessionPersistenceSnapshot } from '@nuaagent/session-persistence'
import SqliteSessionPersistence from '@nuaagent/session-persistence-sqlite'
import SqliteSessionQueryEngine, {
  SESSION_QUERY_SQLITE_SCHEMA_VERSION,
} from '@nuaagent/session-query-sqlite'
import {
