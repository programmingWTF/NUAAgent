...
import { credentialKey, credentialKeyScope, credentialRef, parseCredentialKey } from '@nuaagent/credentials'
import type { CredentialKey, CredentialRecord } from '@nuaagent/credentials'
