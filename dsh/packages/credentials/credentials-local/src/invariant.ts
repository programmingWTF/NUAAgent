/**
 * Package-owned invariant companion for `@nuaagent/credentials-local`.
 * @module @nuaagent/credentials-local/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/credentials-local'
