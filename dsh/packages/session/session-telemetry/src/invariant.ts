/**
 * Package-owned invariant companion for `@nuaagent/session-telemetry`.
 * @module @nuaagent/session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/session-telemetry'
