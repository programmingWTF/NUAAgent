 ...
 * @module @nuaagent/session-title
 */

import { Context, FiberState, Service, type Fiber } from '@nuaagent/cordis'
import z from '@nuaagent/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@nuaagent/brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@nuaagent/llm'
import type { GenerateOptions } from '@nuaagent/llm'
import type {
  Session,
  SessionEvent,
