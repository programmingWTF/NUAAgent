/**
 * Package-owned invariant companion for `@nuaagent/session-telemetry-otel`.
 * @module @nuaagent/session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/session-telemetry-otel'
