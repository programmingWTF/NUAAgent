/**
 * Package-owned invariant companion for `@nuaagent/session-projection`.
 * @module @nuaagent/session-projection/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/session-projection'
