/**
 * Package-owned invariant companion for `@nuaagent/session-projection-cache`.
 * @module @nuaagent/session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/session-projection-cache'
