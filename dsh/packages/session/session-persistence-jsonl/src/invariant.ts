/**
 * Package-owned invariant companion for `@nuaagent/session-persistence-jsonl`.
 * @module @nuaagent/session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/session-persistence-jsonl'
