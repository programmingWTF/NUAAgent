/**
 * Package-owned invariant companion for `@nuaagent/session-title-llm`.
 * @module @nuaagent/session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/session-title-llm'
