/**
 * Package-owned invariant companion for `@nuaagent/session-checkpoint-policy`.
 * @module @nuaagent/session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/session-checkpoint-policy'
