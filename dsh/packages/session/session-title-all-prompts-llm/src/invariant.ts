/**
 * Package-owned invariant companion for `@nuaagent/session-title-all-prompts-llm`.
 * @module @nuaagent/session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/session-title-all-prompts-llm'
