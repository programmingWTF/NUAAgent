/**
 * Package-owned invariant companion for `@nuaagent/session-title-first-prompt-llm`.
 * @module @nuaagent/session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/session-title-first-prompt-llm'
