/**
 * Package-owned invariant companion for `@nuaagent/session-persistence`.
 * @module @nuaagent/session-persistence/invariant
 */
...
const PACKAGE_NAME = '@nuaagent/session-persistence'
