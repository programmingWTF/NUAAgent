 ...
 * @module @nuaagent/session-persistence
 */

import { Context, Service } from '@nuaagent/cordis'
import { SessionPreparation } from '@nuaagent/session'
import type { SessionEvent, SessionId, SessionHeader } from '@nuaagent/session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@nuaagent/session'
