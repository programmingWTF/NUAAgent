...
import type { ApprovalRequestId } from '@nuaagent/user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@nuaagent/host-apiproxy/api'
import type { RpcId } from '@nuaagent/host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@nuaagent/host-apiproxy/api/rpc'
