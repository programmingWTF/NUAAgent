...
import type { SessionHeader, SessionId } from '@nuaagent/session'
...
import type { RpcRequest } from '@nuaagent/host-apiproxy/api'
import { RpcId } from '@nuaagent/host-apiproxy/api'
