...
import { TypertLookupFailure } from '@nuaagent/typert-protocol'
import TypertRegistry from '@nuaagent/typert-registry'
import { createUserMessage, MessageId } from '@nuaagent/llm'
import type { Agent } from '@nuaagent/agent'
import UserQuestionService from '@nuaagent/user-questions'
import type { SessionEvent, SessionHeader, SessionId } from '@nuaagent/session'
import {
  PersistenceCoordinator,
  SessionPersistenceRevision,
  type PersistenceBackend,
  type StoredPrefix,
} from '@nuaagent/session-persistence'
import type { RpcRequest } from '@nuaagent/host-apiproxy/api/rpc'
...
describe('Remote Agent and Session lookup policy', () => {
  it('deduplicates a cold resume across Agent and Session parameters', async () => {
    ...
    const resumedSession = { id: sessionId, header: meta, events: [] } as unknown as import('@nuaagent/session').Session
