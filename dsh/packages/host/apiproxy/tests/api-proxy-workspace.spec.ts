...
import type { Agent, AgentFactory } from '@nuaagent/agent'
...
import type { DirectoryPickerCapability } from '@nuaagent/host-directory-picker'
import WorkspaceRegistry from '@nuaagent/workspace'
import type { HostFrame, WorkspaceId } from '@nuaagent/host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@nuaagent/host-apiproxy/api/rpc'
import { RpcId } from '@nuaagent/host-apiproxy/api/rpc'
import { createApiProxy } from '@nuaagent/host-apiproxy'
