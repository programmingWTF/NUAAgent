...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@nuaagent/attachment'
import type { ContentBlock } from '@nuaagent/llm/types'
import type { SessionEvent, SessionId } from '@nuaagent/session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via dsh-agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@nuaagent/session-projection/types'
