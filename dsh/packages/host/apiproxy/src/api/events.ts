...
import type { AskUserQuestionItem } from '@nuaagent/user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@nuaagent/user-approval/types'
import type { Message } from '@nuaagent/llm/types'
import type { MessageId } from '@nuaagent/llm/brand'
import type { CallId } from '@nuaagent/llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@nuaagent/session/types'
import type { ToolCallView, ToolResultView } from '@nuaagent/tools/presentation'
...
export type { ToolCallView, ToolResultView } from '@nuaagent/tools/presentation'
...
export type HostFrame =
   ...
   * owned by `@nuaagent/api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
