...
import HttpServer from '@nuaagent/host-webserver'
import type { DirectoryPicker } from '@nuaagent/host-directory-picker'
import BrowseDirectoryPicker from '@nuaagent/host-directory-picker-browse'
import NativeDirectoryPicker from '@nuaagent/host-directory-picker-native'
...
const AUTO = '@nuaagent/host-directory-picker-auto'
const NATIVE = '@nuaagent/host-directory-picker-native'
const BROWSE = '@nuaagent/host-directory-picker-browse'
const NATIVE_SURFACE = '@nuaagent/client-ui-directory-picker-native'
const BROWSE_SURFACE = '@nuaagent/client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  const modules = new Map<string, unknown>([
    ['@nuaagent/host-webserver', HttpServer],
