 ...
 * @module @nuaagent/host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@nuaagent/host-directory-picker-native',
  browse: '@nuaagent/host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@nuaagent/client-ui-directory-picker-native',
  browse: '@nuaagent/client-ui-directory-picker-browse',
}
