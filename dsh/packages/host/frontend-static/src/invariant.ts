/**
 * Package-owned invariant companion for `@nuaagent/host-frontend-static`.
 * @module @nuaagent/host-frontend-static/invariant
 */

import type { Context } from '@nuaagent/cordis'
import type { InvariantInstaller } from '@nuaagent/invariants'

const PACKAGE_NAME = '@nuaagent/host-frontend-static'
