/** Package-owned invariant companion for the directory-picker seam. @module @nuaagent/host-directory-picker/invariant */

import type { Context } from '@nuaagent/cordis'
import type { InvariantInstaller } from '@nuaagent/invariants'

const PACKAGE_NAME = '@nuaagent/host-directory-picker'
