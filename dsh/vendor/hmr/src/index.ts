import { Context, Service, type Plugin } from '@nuaagent/cordis'
import type { Dict } from '@nuaagent/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@nuaagent/cordis-plugin-loader'
import type { Include } from '@nuaagent/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@nuaagent/cordis-plugin-timer'
