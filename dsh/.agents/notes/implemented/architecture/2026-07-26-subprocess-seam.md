...
Every composition that loads a bash executor also loads `@nuaagent/subprocess-local` (CLI, examples, the Python bundled runtime, and inline test configs).
