...
- `packages/*` (except agent-loop's own tests and examples/) must not import `@nuaagent/agent-loop`.
- No cross-package deep imports (`@nuaagent/*/src/...` paths) — public entry points only.
