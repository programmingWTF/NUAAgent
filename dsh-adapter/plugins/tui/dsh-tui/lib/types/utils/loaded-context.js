...
export function summarizeLoadedContext(context) {
    ...
    if (context.sections.length > 0)
        parts.push(t('context-sections', { n: context.sections.length }));
    if (context.files.length > 0)
        parts.push(t('context-files', { n: context.files.length }));
    if (context.contexts.length > 0)
        parts.push(t('context-runtime', { n: context.contexts.length }));
    if (context.skills.length > 0)
        parts.push(t('context-skills', { n: context.skills.length }));
    if (context.tools.length > 0)
        parts.push(t('context-tools', { n: context.tools.length }));
    return parts.join(' · ');
}
