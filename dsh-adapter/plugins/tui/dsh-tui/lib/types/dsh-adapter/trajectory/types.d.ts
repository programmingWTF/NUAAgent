...
export type TrajKind = 'turn' | 'step' | 'user' | 'assistant' | 'thinking' | 'tool' | 'subtool' | 'retry' | 'approval' | 'compaction' | 'system' | 'context' | 'todo';
...
export declare function burstDurationMs(burst: TrajBurst): number;
/** Number of burst members that failed. */
export declare function burstErrors(burst: TrajBurst): number;
/** True while any burst member is still running. */
export declare function burstRunning(burst: TrajBurst): boolean;
/**
...
export declare const BURST_MIN = 3;
...
export declare const WAVE_PROJECTIONS: readonly WaveProjection[];
...
export declare const HOTSPOT_SORTS: readonly HotspotSort[];
/**
 ...
 */
export declare function previewText(raw: string, limit: number): string;
