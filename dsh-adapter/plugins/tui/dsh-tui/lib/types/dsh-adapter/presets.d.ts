...
import type { AgentSetup } from '@nuaagent/agent';
 ...
 */
export declare function filterMinimalPresetTools(assembly: PromptAssembly, presetId: string | undefined): PromptAssembly;
/**
