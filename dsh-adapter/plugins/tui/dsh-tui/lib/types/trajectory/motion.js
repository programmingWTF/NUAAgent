 ...
 */
import { interpolateColor, parseRGB } from '../components/Spinner/spinnerUtils.js';
 ...
 */
export function mix(base, highlight, t) {
 ...
 */
function elapsed(tick, startTick, span) {
 ...
 */
export function arrive(tick, startTick) {
 ...
 */
export function reproject(tick, startTick) {
 ...
 */
export function alert(tick, startTick) {
 ...
 */
export function aliveColor(tick, base, highlight) {
