...
import type { WorkspaceView } from '@nuaagent/host-apiproxy/api/workspace'
import type { SessionSummary, SessionModels, SessionProjectionsBlock } from '@nuaagent/host-apiproxy/api/sessions'
...
export interface HistoryPage {
  events: import('@nuaagent/host-apiproxy/api/sessions').HistoryEntry[]
  hasMore: boolean
  /**
