...
export const ACCEPTED_IMAGE_MIME = ['image/png', 'image/jpeg', 'image/gif', 'image/webp'];
 ...
 */
export function insertNoteIntoDraft(draft, note, caret) {
    if (note === '')
        return draft;
 ...
 */
export function admitPickedImage(file) {
