...
import { IconBranchOutline16 } from '@nuaagent/client-ui-primitives';
...
export function BranchChip(props) {
    ...
    const [dockInset, setDockInset] = useState(null);
    ...
    return (_jsxs("div", { ref: anchorRef, "data-gitgraph-chip-anchor": true, "data-gitgraph-stock-light": stockLightTheme || undefined, className: cx(css.anchor, dockSeat && css.anchorDock, heroSeat && css.anchorHero), style: heroSeat && heroPlacement !== null
