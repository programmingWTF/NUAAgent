...
// @nuaagent/token-meter/projection).
import type {} from '@nuaagent/session-projection/types'
import type { Message, StreamChunk, TokenUsage } from '@nuaagent/llm'
import type { EpochHeader, SessionEvent, SurfaceEvent } from '@nuaagent/session'
import { isSurfaceEvent } from '@nuaagent/session'
import type { ProjectionDefinition } from '@nuaagent/session-projection'
import type { LiveTokenUsageProjection, TokenUsageProjection } from '@nuaagent/token-meter/client'
import {
